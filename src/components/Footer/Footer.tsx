  ...
  return (
    ...
    >
        ...
        <MDBContainer className="text-center text-md-start mt-5">
          <MDBRow className="mt-3">
            <MDBCol md="3" lg="4" xl="3" className="mx-auto mb-4">
              ...
              <p className="footer-p">{t("footer.aboutFigr.description")}</p>
            </MDBCol>

            <MDBCol md="2" lg="2" xl="2" className="mx-auto mb-4">
              <h6 className="text-uppercase fw-bold mb-4 text-underline">
                {t("footer.products.heading")}
              </h6>
              <p>
                <Link to="/consoleCranes">
                  {t("footer.products.items.0.label")}
                </Link>
              </p>
              <p>
                <Link to="/gantryCranes">
                  {t("footer.products.items.1.label")}
                </Link>
              </p>
              <p>
                <Link to="/overheadCranes">
      ...
      <div
        ...
        style={{ backgroundColor: "rgba($orange" }}
      >
        <a
          href="/home"
